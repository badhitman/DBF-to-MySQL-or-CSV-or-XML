...
namespace DBF_to_MySQL__CSV_and_XML
{
    ...
    {
        private delegate void DelegateLoadWeb(System.Windows.Controls.WebBrowser _web, string url);
        DelegateLoadWeb DelegateLoadWeb1;
        DelegateLoadWeb DelegateLoadWeb2;
        DelegateLoadWeb DelegateLoadWeb3;
        ...
        string curr_ext_file = "sql";
        public MainWindow()
        {
            InitializeComponent();
            g.RegManager = new ModifyRegistry();
        }
        private void DBFRefrash_Click(object sender, RoutedEventArgs e)
        {
        ...
        private void Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            //my_parser.SaveAs(selected_file_path, curr_ext_file, del_inc_CheckBox.IsChecked.Value, UpdateStatus);
        }
